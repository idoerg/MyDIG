...
DATABASES = {
    'default': {
        ...
        'USER': 'mycoplasma',                      # Not used with sqlite3.
        'PASSWORD': '5i72c44u',                  # Not used with sqlite3.
...
MEDIA_ROOT = '/var/www/mycoplasma_site/mycoplasma_home/media'
...
STATIC_ROOT = '/var/www/mycoplasma_site/static'
...
STATICFILES_DIRS = (
    ...
    '/var/www/mycoplasma_site/mycoplasma_home/static',
)
...
ROOT_URLCONF = 'mycoplasma_site.urls'
...
TEMPLATE_DIRS = (
    ...
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    '/var/www/mycoplasma_site/mycoplasma_home/templates',
)
...
DATABASE_ROUTERS = ['mycoplasma_home.routers.DBRouter']
