...
urlpatterns = patterns('mycoplasma_home.views.applications.public',
    # Examples:
...
urlpatterns += patterns('mycoplasma_home.views.applications.registered',
    ...
    #url(r'^administration/image_manager/$', 'mycoplasma_home.views.image_manager'),
...
urlpatterns += patterns('', 
    ...
    url(r'^uploader/', include('mycoplasma_site.multiuploader.urls'), name='main')
)
